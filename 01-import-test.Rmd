...
Testing here is to import a bunch of csv files into a single dataframe. Note the files in `data-test` had a header row added by hand, which the social security files don't have. This would not be doable for all the data, but you _should_ be able to create a tibble with the names first and then ignore header on import and then bind them to it. Perhaps.
